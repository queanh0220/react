export const posts = [
  {
    ...
    text: "The modern Internet with its TCP/IP protocol started around 1975 which is astonishing 41 years ago. For the most part of its existence, we used HTTP and its successor HTTP/1.1 (version 1.1) to communicate between clients and servers.",
  },
  {
    slug: "es6",
    title: "Top 10 ES6 Features Every Busy JavaScript Developer Must Know",
    link: "http://webapplog.com/es6/",
    text: "This essay will give you a quick introduction to ES6. If you dont know what is ES6, its a new JavaScript implementation...",
  },
  {
